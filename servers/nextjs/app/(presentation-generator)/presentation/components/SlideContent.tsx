    ...
    <>
      ...
      >
        ...
        <div
          ...
          className={` w-full  group font-sans  `}
        >
            ...
            >
              <Popover open={isEditPopoverOpen} onOpenChange={setIsEditPopoverOpen}>
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className="flex px-3.5 py-2.5 items-center justify-center rounded-full bg-[#F7F6F9] font-sans"
                  >
                ...
                <PopoverContent
                  ...
                  align="center"
                  sideOffset={12}
                  className="z-30 w-[340px] rounded-2xl border border-gray-200 bg-white p-0 shadow-2xl font-sans"
                >
              ...
              <Popover open={isSpeakerPopoverOpen} onOpenChange={setIsSpeakerPopoverOpen}>
                <PopoverTrigger asChild>
                  <button
                    ...
                    className={`flex px-4 py-2.5 items-center justify-center rounded-full border font-sans ${slide?.speaker_note
              ...
              <button
                ...
                className="flex px-4 py-2.5 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-600 font-sans"
              >
