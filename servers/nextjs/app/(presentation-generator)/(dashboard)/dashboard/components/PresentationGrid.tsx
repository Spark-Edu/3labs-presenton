...
export const PresentationGrid = ({
  ...
  const CreateNewCard = () => (
    <div
      ...
      className="flex flex-col cursor-pointer group ring-1 ring-inset ring-slate-200 hover:ring-[#8A7DFF]/40 bg-white/80 rounded-xl overflow-hidden transition-all duration-300 font-sans"
    >
