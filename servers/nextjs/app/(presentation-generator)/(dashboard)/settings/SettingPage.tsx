    ...
    <div className="h-screen font-sans flex flex-col overflow-hidden relative">
        ...
        <div className="w-full">
          <div className="sticky top-0 right-0 z-50 py-[28px]   backdrop-blur mb-4 ">
            <div className="flex  gap-3 items-center ">
              <h3 className=" text-[28px] tracking-[-0.84px] font-sans font-normal text-black flex items-center gap-2">
                Settings
              </h3>
      ...
      <div className=" mx-auto fixed bottom-20 right-5 ">
        <button
          ...
          className={`w-full font-sans font-semibold flex items-center justify-center gap-2 py-3 px-5 rounded-[58px] transition-all duration-500 ${buttonState.isDisabled
