    ...
    <div className='relative h-[250px] flex justify-center items-center '>
      ...
      <div className=" absolute top-0 left-0 flex items-center justify-between gap-2  z-[2] p-2">
        <ToolTip content='Font' >
          ...
          <p className=" text-xs font-sans  flex gap-1 capitalize  items-center  rounded-[100px]  px-2.5 py-1 bg-[#3A3A3AF5] text-white font-semibold  z-40 ">
        ...
        {theme.company_name && <ToolTip content='COMPANY'>
          ...
          <p className=" text-xs font-sans  flex gap-1 capitalize  items-center  rounded-[100px]  px-2.5 py-1 bg-[#3A3A3AF5] text-white font-semibold  text-ellipsis overflow-hidden whitespace-nowrap z-40 ">
