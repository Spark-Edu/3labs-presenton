        ...
        <div className="space-y-2" data-testid="attachments-uploader">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    disabled={!hasFiles}
                    className={`text-sm font-medium font-sans ${!hasFiles ? 'cursor-not-allowed text-gray-400' : 'text-red-600 hover:text-red-700'}`}
                        ...
                        {filteredFiles.map((file, idx) => (
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="truncate text-sm font-medium text-gray-900 font-sans" title={file.name}>
                                        {file.name}
                                    </p>
